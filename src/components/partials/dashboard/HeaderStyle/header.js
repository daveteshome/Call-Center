        ...
        <>
            <Navbar expand="lg" variant="light" className="nav iq-navbar">
                <Container fluid className="navbar-inner">
                    ...
                    <div className="input-group search-input ms-auto d-none d-lg-block d-xl-block ">
                      <h3 className=' font-extrabold text-uppercase' >Welcome to Elilta Trading Company</h3>
                    </div>
